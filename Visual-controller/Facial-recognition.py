...
while True:
    ...
    profileFace = profile_face.detectMultiScale(gray_img,
     scaleFactor=1.05,
     minNeighbors=5)
    ...
    for x, y, w, h in faces:
        ...
        cv2.putText(gray_img, 'Front user', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 0), 2)

    for x, y, w, h in profileFace:
        gray_img = cv2.rectangle(gray_img, (x, y), (x + w, y + h), (0, 255, 0), 3)
        cv2.putText(gray_img, 'Profile user', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 0), 2)
